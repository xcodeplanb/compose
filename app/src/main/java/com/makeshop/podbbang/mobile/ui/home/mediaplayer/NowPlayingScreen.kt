...
// */
//
//package com.makeshop.podbbang.mobile.mediaplayer
//
...
//
//    val buttonWidth = dimensionResource(id = R.dimen.text_margin)
//    val margins = dimensionResource(id = R.dimen.text_margin)
//
//    val play = painterResource(id = androidx.mediarouter.R.drawable.ic_media_play_dark)
//    val pause = painterResource(id = androidx.mediarouter.R.drawable.ic_media_pause_dark)
//
